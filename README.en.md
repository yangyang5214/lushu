...
- **Place notes** — every stop can carry a short free-text note, up to 20 characters (parking, tickets, contacts…). Notes are saved and synced with the book, and show up on read-only shared pages too.
