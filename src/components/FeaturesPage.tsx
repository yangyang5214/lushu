...
const FEATURES: Feature[] = [
  ...
  { num: '05', slug: 'note', titleKey: 'feat.note.title', textKey: 'feat.note.text', shot: ShotNote },
  { num: '06', slug: 'rail', titleKey: 'feat.rail.title', textKey: 'feat.rail.text', shot: ShotRail },
  { num: '07', slug: 'legs', titleKey: 'feat.legs.title', textKey: 'feat.legs.text', shot: ShotLegs },
  { num: '08', slug: 'table', titleKey: 'feat.table.title', textKey: 'feat.table.text', shot: ShotTable },
  { num: '09', slug: 'shelf', titleKey: 'feat.shelf.title', textKey: 'feat.shelf.text', shot: ShotShelf },
  { num: '10', slug: 'share', titleKey: 'feat.share.title', textKey: 'feat.share.text', shot: ShotShare },
  { num: '11', slug: 'account', titleKey: 'feat.account.title', textKey: 'feat.account.text', shot: ShotAccount },
  { num: '12', slug: 'mp', titleKey: 'feat.mp.title', textKey: 'feat.mp.text', shot: ShotMiniProgram },
]
