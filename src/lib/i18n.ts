...
const zh = {
  ...
  'sidebar.endBadge': '终',
  'sidebar.nightBadge': '夜',
  'sidebar.overnight': '过夜',
  'sidebar.cancelOvernight': '取消过夜',
  'sidebar.setStart': '起点',
  'sidebar.setEnd': '终点',
...
const en: Record<MsgKey, string> = {
  ...
  'sidebar.titlePlaceholder': 'Untitled book',
  'sidebar.routeName': 'Route name',
  'sidebar.day': 'Day {n}',
  'sidebar.startBadge': 'S',
  'sidebar.endBadge': 'E',
  'sidebar.nightBadge': 'N',
  'sidebar.overnight': 'Overnight',
  'sidebar.cancelOvernight': 'Remove overnight',
  ...
  'home.heroTitle2': 'and let the order and days sort themselves out',
  'home.lede':
    'Stop agonizing over where to go first or how far to drive each day. Just search in the places; the book links them by distance, and pins at overnight stops split the trip into days.',
  'home.newBook': 'New book',
  'home.seePublic': 'Browse public books',
  ...
  'feature.2.key': 'Shelf',
  'feature.2.title': 'My books',
  'feature.2.text':
    'Every book you write lives on the shelf — duplicate it, rename it, or keep it to yourself.',
  'feature.3.key': 'Public',
  'feature.3.title': 'Public books',
  'feature.3.text':
    'Publish it and it appears under Public books; anyone with the link can see the full route and each day of the trip.',
  ...
  'mine.heading': 'My books',
  'mine.newBook': 'New book',
  'mine.syncing': 'Syncing your books…',
  'mine.empty': 'You have no books yet',
  'mine.confirmPublic': 'Confirm public',
  'mine.makePublic': 'Make public',
  'mine.makePrivate': 'Make private',
  'mine.confirmDelete': 'Confirm delete',

  'public.heading': 'Public books',
  'public.count': '{n} books',
  'public.empty': 'No public books yet',
  ...
  'admin.statBooks': 'Total books',
  'admin.statPublic': 'Public books',
  'admin.statPrivate': 'Private books',
  ...
  'admin.searchBookPlaceholder': 'Search book title',
  'admin.search': 'Search',
  'admin.colId': 'ID',
  'admin.colEmail': 'Email',
  'admin.colName': 'Name',
  'admin.colHashId': 'Public ID',
  'admin.colBooks': 'Books',
  ...
  'admin.withBooks': 'Including {n} book(s)',
  ...
  'meta.title': 'Lushu · Add places freely, auto-link and split into days',
}
