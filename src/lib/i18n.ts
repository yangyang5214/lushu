...
const zh = {
  ...
  'mp.title2': '手机上打开看',
  'mp.lede':
    '用微信扫小程序码，在 gpx merge 里看路线、天数和每天行程。电脑上规划，出门带着走。',
  'mp.hint': '微信扫一扫打开',
  'mp.alt': '微信小程序 gpx merge 的小程序码',
  'mp.f1.title': '扫码即开',
  'mp.f1.text': '不用另装 App，微信扫一下就能进。',
  'mp.f2.title': '按天看路',
  'mp.f2.text': '路线、过夜和每天行程都在手机上。',
  'mp.f3.title': '随时翻看',
  'mp.f3.text': '路上打开就能对照当天要走的点。',
  'mp.shotsHeading': '手机里怎么看',
  'mp.shotsSub': '从路书列表到按天行程，再到点开导航。',
  'mp.s1.title': '路书列表',
  'mp.s1.text': '扫码进来就能翻自己的行程，天数和里程一眼能看清。',
  'mp.s1.alt': '小程序路书列表截图',
  'mp.s2.title': '路线详情',
  'mp.s2.text': '地图、总里程和每天行程铺在同一页。',
  'mp.s2.alt': '小程序路书详情截图',
  'mp.s3.title': '按天展开',
  'mp.s3.text': '哪天走哪段、在哪过夜，点开就能对照。',
  'mp.s3.alt': '小程序按天行程截图',
  'mp.s4.title': '一键导航',
  'mp.s4.text': '点开地点就能去这里，路上不用再切 App。',
  'mp.s4.alt': '小程序地点导航截图',
...
const en: Record<MsgKey, string> = {
  ...
  'mp.name': 'gpx merge',
  'mp.title1': 'Write on the desktop,',
  'mp.title2': 'open it on your phone',
  'mp.lede':
    'Scan the code in WeChat to open gpx merge — routes, overnight stops and each day’s plan, in your pocket.',
  'mp.hint': 'Scan with WeChat to open',
  'mp.alt': 'WeChat Mini Program QR code for gpx merge',
  'mp.f1.title': 'Open by scanning',
  'mp.f1.text': 'No extra app. Scan once in WeChat and you are in.',
  'mp.f2.title': 'See each day',
  'mp.f2.text': 'The route, overnight pins and daily legs all sit on your phone.',
  'mp.f3.title': 'Check on the road',
  'mp.f3.text': 'Open it anytime and match the stops you meant to hit today.',
  'mp.shotsHeading': 'On your phone',
  'mp.shotsSub': 'From the book list to each day’s plan, then tap to navigate.',
  'mp.s1.title': 'Book list',
  'mp.s1.text': 'Scan in and browse your trips — days and distance at a glance.',
  'mp.s1.alt': 'Mini Program screenshot of the roadbook list',
  'mp.s2.title': 'Route detail',
  'mp.s2.text': 'Map, total distance and the day’s stops sit on one screen.',
  'mp.s2.alt': 'Mini Program screenshot of a roadbook detail',
  'mp.s3.title': 'Day by day',
  'mp.s3.text': 'Which stretch on which day, and where you overnight — tap to check.',
  'mp.s3.alt': 'Mini Program screenshot of the day-by-day itinerary',
  'mp.s4.title': 'Navigate',
  'mp.s4.text': 'Open a stop and go there, without switching to another app.',
